    ...
    <body>
        <div id="Profil">
            ...
            <div id="left">
                ...
                <p>
                    <font class="username">Gaiser<!--Benutzername--></font>
                </p>
                <hr/>
                <p>
                    <font class="status">Arbeitslos<!--Status--></font>
                </p>
                <hr/>
                <p>
                    Projekt
<<<<<<< HEAD
                    <font class="project"><p>1</p><!--Projekt--></font>
=======
                    <font class="project"><!--Projekanzahlt--></font>
>>>>>>> 12ae3dd74fef69b0e12d9ad66e485392d81b66b9
                </p>
                <hr/>
            </div>
            <div id="right">
